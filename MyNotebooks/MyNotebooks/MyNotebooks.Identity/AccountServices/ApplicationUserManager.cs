...
namespace MyNotebooks.Identity.AccountServices
{
    public class ApplicationUserManager : UserManager<User>, IApplicationUserManager
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<User>(context.Get<NotebooksDbContext>()));
        ...
        public bool CreateUser(MyNotebooks.DataModels.Contracts.IUser user, string password)
        {
